...
public class JWTUtil {
    ...
    public static String createJWTByObj(TokenObject tokenObject) throws IOException {
        ...
        JwtBuilder builder = Jwts.builder().setHeaderParam("typ", "JWT")
                ...
                .signWith(SignatureAlgorithm.HS256, "this-is-a-very-secret-key-for-jwt!".getBytes(StandardCharsets.UTF_8));  //用密钥签名
    ...
    public static int decode(String token) throws IOException {
        ...
        Claims claims = Jwts.parser()
                // 设置签名的秘钥
                .setSigningKey("this-is-a-very-secret-key-for-jwt!".getBytes(StandardCharsets.UTF_8))
                // 设置需要解析的jwt
